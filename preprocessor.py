...
def preprocess_image(url, filename):
    ...
    try:
        ...
        # 3. Clip the file
        xmin, ymin, xmax, ymax = '576519', '2885329', '668007', '2946671' # Your project coordinates
        ...
        subprocess.run(["python3", "predictor.py", "--input", output_tif])

    except Exception as e:
        print(f"An error occurred in preprocessor: {e}")
